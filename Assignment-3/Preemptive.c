...
int main(void){
    ...
    printf("\n");
    printf("+-----+--------------+------------+-----------+------+-------+------+------+\n");
    printf("| PID | Arrival Time | Burst Time | Wait Time | TAT  | Start | End  | Rem  |\n");
    printf("+-----+--------------+------------+-----------+------+-------+------+------+\n");
     printf("| %3d | %-12.1f | %-10.1f | %-9.1f | %-4.1f | %-5.1f | %-4.1f | %-4.1f |\n",
        p[index].pid,p[index].at,p[index].bt,p[index].wt,p[index].tat,p[index].st,p[index].et,p[index].rt);
